---
title: Terms of Use
description: Terms and conditions governing your use of unseal.link.
og_title: Terms of Use
og_description: Terms and conditions governing your use of unseal.link.
schema_type: WebPage
published: true
noindex: true
---
...
Version 1.3 — Last revised: June 23, 2026

The website located at unseal.link (the "Site") is a copyrighted work belonging to unseal.link ("Company", "us", "our", and "we"). Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features. All such additional terms, guidelines, and rules are incorporated by reference into these Terms.
...
**4.3 Platform Fee.** Company charges sellers a platform fee per sale, as displayed on the Site's pricing page. Platform fees are subject to change with reasonable notice.

**4.3.1 Promotions and Fee Waivers.** Company may, at its sole discretion, offer promotional fee waivers, credits, or rate reductions ("Promotions") to eligible sellers. The following terms apply to all Promotions:

(a) **Platform fee only.** Promotions apply exclusively to Company's platform fee. They do not cover, offset, or waive any fees charged by Stripe or other third-party payment processors. Stripe's standard processing fees (including card processing fees) remain the seller's responsibility regardless of any active Promotion.

(b) **Modification and revocation.** Company reserves the right to modify, suspend, or revoke any Promotion at any time, with or without notice, including in cases of suspected abuse, fraud, or violation of these Terms. Revocation of a Promotion does not entitle the seller to any refund or compensation.

(c) **Non-transferable.** Promotions are granted to individual seller accounts and may not be transferred, sold, or assigned to any other account or person.

(d) **One per account.** Unless explicitly stated otherwise, each Promotion is limited to one redemption per seller account. Creating multiple accounts to obtain additional Promotions is prohibited and may result in account termination.

(e) **No cash value.** Promotions have no cash value and cannot be redeemed for cash, credit, or any monetary equivalent.

(f) **Expiry.** Promotions may be subject to expiry dates, GMV caps, or usage limits as specified at the time of grant. Unused promotional value that expires or is exhausted is forfeited with no recourse.

(g) **Eligibility.** Company determines Promotion eligibility at its sole discretion. Eligibility criteria may change at any time without notice.
...
**4.5 Non-Custodial Crypto Payments.** Where available, sellers may opt to accept cryptocurrency payments via Solana. All such transactions settle directly on-chain between the buyer and the seller's designated Solana wallet address. Company does not at any time hold, custody, control, or have access to any cryptocurrency or digital assets on behalf of sellers or buyers. Sellers are solely responsible for the accuracy and security of any wallet address they provide. Company cannot reverse, recover, or redirect on-chain transactions under any circumstances.

**4.6 Refunds.** Refund decisions for buyer purchases are at the sole discretion of the seller, except where required by applicable law. Buyers with disputes regarding purchased content should contact the relevant seller directly. Company may, at its sole discretion, intervene in disputes involving fraud or misrepresentation.

**4.7 No Guarantee of Content.** Company does not review, verify, endorse, or guarantee the quality, accuracy, legality, or availability of any content linked by sellers. Company is not responsible for any loss or damage arising from a buyer's access to or use of seller content.

**4.8 Seller Responsibilities and Access Delivery.** When you create, publish, or sell an access product through unseal.link, you are responsible for making sure that the product listing is accurate, lawful, and deliverable. By creating or publishing an access product, you confirm that: (a) the product delivers the access described on the listing page; (b) the access link, file, invite, resource, or destination is working at the time of sale; (c) you own the content or have the legal right to sell access to it; (d) the listing description, preview, price, deliverables, and access method are not misleading; (e) buyers are not required to provide passwords, seed phrases, private keys, payment details, or other sensitive information outside the normal checkout or access flow; and (f) the product does not contain prohibited content or violate these Terms.

**4.9 Broken, Misleading, or Prohibited Access.** Company may review, restrict, pause, remove, or suspend any product or seller account if we believe that a product: (a) does not deliver the access described; (b) contains a broken, expired, unavailable, or incorrect access link; (c) is materially different from the listing shown to buyers; (d) is deceptive, misleading, or likely to cause buyer complaints; (e) contains or links to prohibited content; (f) violates the rights of another person or company; or (g) creates risk for buyers, Company, our payment providers, or our platform.

**4.10 Refunds, Payout Holds, and Cost Recovery.** If a product is broken, deceptive, prohibited, unavailable, or materially different from its listing, Company may: (a) pause or disable sales for the product; (b) remove the product from public discovery or search; (c) request that the seller fix the access link or listing; (d) resend corrected access to affected buyers; (e) refund affected buyers; (f) delay, hold, or restrict seller payouts; (g) suspend or terminate the seller account; or (h) recover refunds, dispute fees, chargeback costs, payment-provider fees, or other related costs from the seller's available balance where permitted by applicable payment-provider rules and law. Company may apply these actions to protect buyers, prevent abuse, comply with payment-provider requirements, or protect the platform.

**4.11 Public Listings and Discovery.** Private access products may be shared directly by the seller. Products submitted for public discovery, category pages, search, featured placement, or other public listing areas may require additional review. Approval for public listing does not mean that Company guarantees the product, endorses the seller, or verifies every part of the delivered content. Company may approve, reject, remove, demote, or re-review public listings at any time.

**4.12 Seller Attestation.** Each time you publish, update, or submit an access product for review, we may ask you to confirm that the product complies with these Terms. You agree that this confirmation is accurate and that Company may rely on it when making review, payout, refund, or enforcement decisions.
...
**10.7 Copyright/Trademark Information.** Copyright 2026 unseal.link. All rights reserved. All trademarks, logos, and service marks displayed on the Site are the property of unseal.link or other third parties. You are not permitted to use these marks without our prior written consent or the consent of the applicable third party.
