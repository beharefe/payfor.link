...
import { Globe, Lock, Mail, Percent, Share2, Zap } from "lucide-react";
...
const features: { Icon: LucideIcon; title: string; body: string }[] = [
  ...
  {
    Icon: Zap,
    title: "Accept crypto on Solana",
    body: "Buyers can pay in USDC directly from their Solana wallet — no bridge, no conversion. Funds settle on-chain instantly, straight to your wallet address.",
  },
];
